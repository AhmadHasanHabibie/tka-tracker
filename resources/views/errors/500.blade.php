...
<head>
    ...
    <title>500 — Kesalahan Server Internal | UTBK Tracker</title>
...
<body>
    <div class="error-card">
        ...
        <p class="error-desc">
            Terjadi masalah teknis pada server kami. Tim sedang menanganinya, silakan coba memuat ulang halaman.
        </p>
