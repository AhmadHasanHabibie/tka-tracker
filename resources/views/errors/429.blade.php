...
<head>
    ...
    <title>429 — Terlalu Banyak Permintaan | UTBK Tracker</title>
...
<body>
    <div class="error-card">
        ...
        <p class="error-desc">
            Sistem mendeteksi terlalu banyak permintaan dalam waktu singkat. Harap tunggu beberapa detik lalu coba lagi.
        </p>
